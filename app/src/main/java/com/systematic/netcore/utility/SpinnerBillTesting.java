...
public class SpinnerBillTesting extends Spinner implements DialogInterface.OnCancelListener {

    private List<ModelTesting> dataForCustomer;
    ...
    public SpinnerBillTesting(Context context) {
        super(context);
        this.activity = (Activity) context;
        hideKeyboard((Activity) context);
    }

    public SpinnerBillTesting(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public void setDataForCustomer(List<ModelTesting> items, String allText, int position, SpinnerSearchListener listener) {
        ...
        if (position != -1) {
            ModelTesting kpc = items.get(position);
    ...
    public interface SpinnerSearchListener {
        public void onItemsSelected(List<ModelTesting> items);
    }
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        List<ModelTesting> arrayList;
        List<ModelTesting> mOriginalValues; // Original Values
        LayoutInflater inflater;

        public MyAdapter(Context context, List<ModelTesting> arrayList) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final ModelTesting data = arrayList.get(position);
        ...
        public Filter getFilter() {
            Filter filter = new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<ModelTesting>) results.values; // has the filtered values
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    List<ModelTesting> FilteredArrList = new ArrayList<ModelTesting>();

                    if (mOriginalValues == null) {
                        mOriginalValues = new ArrayList<ModelTesting>(arrayList); // saves the original data in mOriginalValues
                    }
