...
public class SpinnerSearchForEngineer extends Spinner implements DialogInterface.OnCancelListener {

    private List<KeyPairForEngineer> dataForEngineer;
    ...
    public SpinnerSearchForEngineer(Context context) {
        super(context);
        this.activity = (Activity) context;
        hideKeyboard((Activity) context);
    }

    public SpinnerSearchForEngineer(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public boolean performClick() {
        ...
        adapter = new MyAdapter(getContext(),dataForEngineer );
    ...
    public void setDataForEngineer(List<KeyPairForEngineer> items, String allText, int position, SpinnerSearchListener listener) {

        this.dataForEngineer = items;
        ...
        if (position != -1) {
            KeyPairForEngineer kpc = items.get(position);
    ...
    public interface SpinnerSearchListener {
        public void onItemsSelected(List<KeyPairForEngineer> items);
    }
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        List<KeyPairForEngineer> arrayList;
        List<KeyPairForEngineer> mOriginalValues; // Original Values
        LayoutInflater inflater;

        public MyAdapter(Context context, List<KeyPairForEngineer> arrayList) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final KeyPairForEngineer data = arrayList.get(position);
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0; i < arrayList.size(); i++) {
                        if (i == position) {
                            ...
                            SettingPreference.Companion.putDataToSharefPref(Constants.Companion.getKeyEngineerID(),data.getId(), activity);
                        }
                    }
                    ...
                    listener.onItemsSelected(dataForEngineer);
        ...
        public Filter getFilter() {
            Filter filter = new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<KeyPairForEngineer>) results.values; // has the filtered values
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    List<KeyPairForEngineer> FilteredArrList = new ArrayList<KeyPairForEngineer>();

                    if (mOriginalValues == null) {
                        mOriginalValues = new ArrayList<KeyPairForEngineer>(arrayList); // saves the original data in mOriginalValues
                    }
