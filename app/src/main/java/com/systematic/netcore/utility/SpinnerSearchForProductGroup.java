...
public class SpinnerSearchForProductGroup extends Spinner implements DialogInterface.OnCancelListener {

    private List<KeyPairForProductGroup> dataForProductGroup;
    ...
    public SpinnerSearchForProductGroup(Context context) {
        super(context);
        this.activity = (Activity) context;
        hideKeyboard((Activity) context);
    }

    public SpinnerSearchForProductGroup(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public boolean performClick() {
        ...
        adapter = new MyAdapter(getContext(),dataForProductGroup );
    ...
    public void setDataForProductGroup(List<KeyPairForProductGroup> items, String allText, int position, SpinnerSearchListener listener) {

        this.dataForProductGroup = items;
        ...
        if (position != -1) {
            KeyPairForProductGroup kpc = items.get(position);
    ...
    public interface SpinnerSearchListener {
        public void onItemsSelected(List<KeyPairForProductGroup> items);
    }
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        List<KeyPairForProductGroup> arrayList;
        List<KeyPairForProductGroup> mOriginalValues; // Original Values
        LayoutInflater inflater;

        public MyAdapter(Context context, List<KeyPairForProductGroup> arrayList) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final KeyPairForProductGroup data = arrayList.get(position);
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0; i < arrayList.size(); i++) {
                        if (i == position) {
                            ...
                            SettingPreference.Companion.putDataToSharefPref(Constants.Companion.getKeyProductGroupID(),data.getId(), activity);
                        }
                    }
                    ...
                    listener.onItemsSelected(dataForProductGroup);
        ...
        public Filter getFilter() {
            Filter filter = new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<KeyPairForProductGroup>) results.values; // has the filtered values
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    List<KeyPairForProductGroup> FilteredArrList = new ArrayList<KeyPairForProductGroup>();

                    if (mOriginalValues == null) {
                        mOriginalValues = new ArrayList<KeyPairForProductGroup>(arrayList); // saves the original data in mOriginalValues
                    }
