...
public class SpinnerSearchForProduct extends Spinner implements DialogInterface.OnCancelListener {

    private List<KeyPairForProduct> dataForProduct;
    ...
    public SpinnerSearchForProduct(Context context) {
        super(context);
        this.activity = (Activity) context;
        hideKeyboard((Activity) context);
    }

    public SpinnerSearchForProduct(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public boolean performClick() {
        ...
        adapter = new MyAdapter(getContext(),dataForProduct );
    ...
    public void setDataForProduct(List<KeyPairForProduct> items, String allText, int position, SpinnerSearchListener listener) {

        this.dataForProduct = items;
        ...
        if (position != -1) {
            KeyPairForProduct kpc = items.get(position);
    ...
    public interface SpinnerSearchListener {
        public void onItemsSelected(List<KeyPairForProduct> items);
    }
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        List<KeyPairForProduct> arrayList;
        List<KeyPairForProduct> mOriginalValues; // Original Values
        LayoutInflater inflater;

        public MyAdapter(Context context, List<KeyPairForProduct> arrayList) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final KeyPairForProduct data = arrayList.get(position);
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0; i < arrayList.size(); i++) {
                        if (i == position) {
                            ...
                            SettingPreference.Companion.putDataToSharefPref(Constants.Companion.getKeyProductID(),data.getId(), activity);
                        }
                    }
                    ...
                    listener.onItemsSelected(dataForProduct);
        ...
        public Filter getFilter() {
            Filter filter = new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<KeyPairForProduct>) results.values; // has the filtered values
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    List<KeyPairForProduct> FilteredArrList = new ArrayList<KeyPairForProduct>();

                    if (mOriginalValues == null) {
                        mOriginalValues = new ArrayList<KeyPairForProduct>(arrayList); // saves the original data in mOriginalValues
                    }
